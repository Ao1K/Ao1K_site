 ...
 * Lives in the suggestion overlay (not the contentEditable) so showing a suggestion
 * never touches the editable HTML or the caret. Box is sized to the measured caret
 * height (not the full line height) so the text sits on the same baseline as the
 * typed text it trails instead of dropping to the bottom of the line box.
 */
