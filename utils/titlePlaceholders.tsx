export const titlePlaceholders = [
  ...
  "Yearn for the incomprehensible!",
  "One thing at a time",
  
  // tips
  "Generic silicone oil is cheaper than cube lube!",
  ...
  "After full OLL and PLL, focus on F2L!",
  "Use untimed solves to fix mistakes and learn",
  "CFOP tends to be about 60 stm",
  "Improve efficiency before turn speed",
  "Prioritize practicing what you're bad at",
  "Lookahead before 15 sec avg is a distraction",
  "Seeing how F2L pairs move can help you learn algs",
