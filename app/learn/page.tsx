...
import LessonParagraph from "../../components/learn/LessonParagraph";
...
export default function Learn() {
  ...
  return (
    <div className="flex flex-col pt-20 pb-10 px-6 max-w-3xl text-md text-primary-100 leading-relaxed">
      ...
      <LessonParagraph paragraph="Below is an incomplete list of lessons for cubing, told through the eyes of a young adventurer, Peaku."/>
      <LessonParagraph paragraph="There is much evil in Peaku's world. The world opened up one day and swallowed his sister. She is not dead. Her presence still beats beside his own heart. What is there to do but find out who took her, claw her back from the dirt?" />
      <LessonParagraph paragraph="Let us begin." />
